...
@section('content')
    ...
    <form action="{{ route('comments.store',$order->id) }}" method="POST" role="form">
        @method('PATCH')
        @csrf
                ...
                <td  style="width: 415px">
                    <div class='form-row row'>
                        <div class='col-xs-12 form-group required'>
                            ...
                            <textarea id="buyer_message" name="buyer_message" class="form-control" rows="10" placeholder="請輸入文章內容"></textarea>
                        </div>
                    </div>
                </td>
            </tr>
