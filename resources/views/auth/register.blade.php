<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            男<x-text-input id="sex" type="radio" name="sex" value="{{ '男' }}" required autocomplete="sex" checked="checked"/>
            女<x-text-input id="sex" type="radio" name="sex" value="{{ '女' }}" required autocomplete="sex" checked="checked"/>
